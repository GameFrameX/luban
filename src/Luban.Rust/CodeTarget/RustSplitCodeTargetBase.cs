...
public abstract class RustSplitCodeTargetBase : RustCodeTargetBase
{
    ...
    public override void Handle(GenerationContext ctx, OutputFileManifest manifest)
    {
        ...
        tasks.Add(Task.Run(() =>
        {
            ...
            return CreateOutputFile($"{GenerationContext.Current.TopModule}/src/{ctx.Target.Manager}.Def.rs", writer.ToResult(FileHeader));
        }));
        ...
        foreach (var table in ctx.ExportTables)
        {
            tasks.Add(Task.Run(() =>
            {
                ...
                return CreateOutputFile($"{GenerationContext.Current.TopModule}/src/{table.FullName}.Def.rs", writer.ToResult(FileHeader));
            }));
        }
        ...
        foreach (var bean in ctx.ExportBeans)
        {
            tasks.Add(Task.Run(() =>
            {
                ...
                return CreateOutputFile($"{GenerationContext.Current.TopModule}/src/{bean.FullName}.Def.rs", writer.ToResult(FileHeader));
            }));
        }
