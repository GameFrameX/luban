...
public class TLang : TType
{
    public static TLang Create(bool isNullable, Dictionary<string, string> tags)
    {
        return new TLang(isNullable, tags);
    }

    public override string TypeName => "lang";

    private TLang(bool isNullable, Dictionary<string, string> tags) : base(isNullable, tags)
    {
    }
