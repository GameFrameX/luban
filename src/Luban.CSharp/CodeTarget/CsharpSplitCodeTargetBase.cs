...
public abstract class CsharpSplitCodeTargetBase : CsharpCodeTargetBase
{
    protected abstract string DefTemplateDir { get; }

    protected abstract string ImplTemplateDir { get; }

    private Scriban.Template GetDefTemplate(string name)
    {
    ...
    private Scriban.Template GetImplTemplate(string name)
    {
